...
| `image.tag`                                      | MinIO image tag. Possible values listed [here](https://hub.docker.com/r/minio/minio/tags/).                                             | `RELEASE.2020-10-18T21-54-12Z`   |
...
> **Tip**: You can use the default [minio/values.yaml](values.yaml)
